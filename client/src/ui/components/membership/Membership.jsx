...
class Membership extends React.Component {
	...
	render() {
		...
		return this.state.lang === "no"
			? renderNo(cheapYear, this.changeLanguage.bind(this, "en"))
			: renderEn(cheapYear, this.changeLanguage.bind(this, "no"));
	}
}

function renderNo(cheapYear, changeLanguage) {
	return (
		<React.Fragment>
			<div className="row">
...
function renderEn(cheapYear, changeLanguage) {
	return (
		<React.Fragment>
			<div className="row">
				...
				<div className="col-12">
					<ul>
						...
						<li>
							...
							telling us you've done this.
						</li>
						<li>
							We have a <strong>card terminal</strong> in the club. This of course means you need to be physically
							present to pay
						</li>
						<li>
							We are required by law to take <strong>cash</strong>, but please use one of the other solutions if you
							can.
						</li>
					</ul>
				</div>
