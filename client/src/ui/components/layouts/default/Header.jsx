			...
			<div id="nav-content" className="collapse navbar-collapse">
				<ul className="navbar-nav mr-auto">
					...
					<li className="nav-item">
						<Link className={`nav-link ${activeTab === "where" ? "active" : ""}`} to="/where">
							Hvor er vi?
						</Link>
					</li>
					{/* Medlemskap */}
					<li className="nav-item">
						<Link className={`nav-link ${activeTab === "membership" ? "active" : ""}`} to="/membership">
							Bli medlem!
						</Link>
					</li>
					{/* Våre spill */}
					<li className="nav-item">
						<Link className={`nav-link ${activeTab === "games" ? "active" : ""}`} to="/games">
							Våre spill
						</Link>
					</li>
					{/* Finn oss på... */}
					<li className="nav-item dropdown">
						...
						<div className="dropdown-menu">
							<a className="dropdown-item" href="https://discord.gg/BF5C9wz" target="_blank" rel="noopener noreferrer">
